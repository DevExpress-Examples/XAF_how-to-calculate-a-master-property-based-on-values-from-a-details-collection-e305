...
Namespace CalculatedPropertiesSolution.Win
    ...
    Public Partial Class CalculatedPropertiesSolutionWindowsFormsApplication
        ...
        Private Sub CalculatedPropertiesSolutionWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs)
        ...
        Private Sub CalculatedPropertiesSolutionWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
            e.Updater.Update();
            e.Handled = true;
#Else
